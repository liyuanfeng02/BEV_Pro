...
namespace Common
{
    public partial class RoundButton : Button
    {
        ...
        {//给个初始值
            HoverBackColor = Color.FromArgb(255, 0, 119, 169);
            EnterBackColor = Color.FromArgb(255, 0, 100, 120);
            PressBackColor = Color.FromArgb(255, 0, 100, 190);
            UpBackColor = Color.FromArgb(255, 0, 100, 120);
            HoverForeColor = Color.White;
            EnterForeColor = Color.White;
            PressForeColor = Color.White;
            UpForeColor = Color.White;
            Radius = 18;
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            switch (paintmodel)
            {
                ...
                case model.enable:
                    ...
                    break;
                case model.up:
                    colorback = UpBackColor;
                    colorfore = UpForeColor;
                    break;
                default:
                    colorback = HoverBackColor;
                    colorfore = HoverForeColor;
